      ...
      >
        ...
        <div className="m-4 max-h-[calc(100dvh-128px)] overflow-y-auto rounded-xl border border-dashed border-pink-300">
          <div className="px-8 py-5 max-md:px-4 max-md:py-5">
            ...
            {/* 게임 소개 박스 */}
            <div className="border-ink-base text-text-primary mb-6 rounded-lg border-2 border-solid bg-pink-300 px-4 py-4 text-[13px] leading-[1.7]">
              도망가는 고양이를 쫓아가서{' '}
            ...
            <SectionItem>
              <b>조작 :</b> WASD 또는 방향키로 츄와와 이동 / 스페이스바로도 시작
              가능
            </SectionItem>
            <SectionItem>
            ...
            <SectionItem>
              <b>목표 :</b>{' '}
              <b className="text-text-accent">30초 내 뽀뽀 10회</b>면 츄와와 승!
              시간 다 가면 고양이 승!
            </SectionItem>
            <div className="text-text-primary mb-4 text-[13px] leading-[1.6]">
            ...
            <ItemBox title="💎 PvP 아이템 (전용)">
              <div>
                🦴 <b>사료</b> — 츄와와만 픽업 가능. 부스트 ×1.55 (5초)
              </div>
              <div>
                🥒 <b>오이</b> — 고양이만 픽업 가능. 고양이 부스트 ×1.85 (3초)
              </div>
              <div>
                🐟 <b>물고기</b> — 둘 다 픽업 가능. 쉴드 부여 (또는 디버프 해제)
              </div>
              <div>
                🍠 <b>고구마</b> — 둘 다 픽업 가능. 상대방 슬로우 ×0.55 (3초)
              </div>
            </ItemBox>
...
function SectionTitle({ children }: { children: ReactNode }) {
  return (
    <div className="text-text-primary mb-3 border-b-[3px] border-solid border-pink-700 pb-2 text-[18px] font-bold">
      {children}
    </div>
  )
}
